...
**
** Created: Sat Oct 20 23:38:48 2012
...
public:
    ...
    QLabel *label_35;
    QSlider *gaussianbluSigmaSlider;
    ...
    void setupUi(QTabWidget *ExtVideoWidget)
    {
        ...
        gridLayout3 = new QGridLayout(logoEnable);
        ...
        gridLayout3->addWidget(logoYSpin, 1, 1, 1, 2);
        ...
        gridLayout3->addWidget(logoXSpin, 2, 1, 1, 2);
        ...
        gridLayout3->addWidget(logoOpacitySlider, 5, 0, 1, 5);
        ...
        gridLayout3->addWidget(label_49, 6, 4, 1, 1);
        ...
        gridLayout3->addWidget(label_22, 4, 0, 1, 3);
        ...
        gridLayout3->addWidget(label_48, 6, 0, 1, 1);
        ...
        gridLayout3->addWidget(line, 3, 0, 1, 5);
        ...
        gridLayout4->addWidget(eraseXSpin, 3, 1, 1, 1);
        ...
        gridLayout_12 = new QGridLayout(tab_9);
        ...
        gridLayout_12->addWidget(antiflickerEnable, 2, 0, 1, 1);
        ...
        gridLayout_7 = new QGridLayout(cloneEnable);
        ...
        gridLayout_7->addWidget(cloneCountSpin, 0, 1, 1, 1);


        gridLayout_12->addWidget(cloneEnable, 2, 2, 1, 1);

        rippleEnable = new QCheckBox(tab_9);
        rippleEnable->setObjectName(QString::fromUtf8("rippleEnable"));

        gridLayout_12->addWidget(rippleEnable, 4, 2, 1, 1);
        ...
        gaussianbluSigmaSlider = new QSlider(gaussianblurEnable);
        gaussianbluSigmaSlider->setObjectName(QString::fromUtf8("gaussianbluSigmaSlider"));
        gaussianbluSigmaSlider->setMinimum(1);
        gaussianbluSigmaSlider->setMaximum(127);
        gaussianbluSigmaSlider->setValue(80);
        gaussianbluSigmaSlider->setOrientation(Qt::Horizontal);
        gaussianbluSigmaSlider->setTickPosition(QSlider::TicksBelow);
        gaussianbluSigmaSlider->setTickInterval(16);

        gridLayout_17->addWidget(gaussianbluSigmaSlider, 0, 1, 1, 1);


        gridLayout_12->addWidget(gaussianblurEnable, 6, 0, 2, 1);

        mirrorEnable = new QCheckBox(tab_9);
        mirrorEnable->setObjectName(QString::fromUtf8("mirrorEnable"));

        gridLayout_12->addWidget(mirrorEnable, 6, 2, 1, 1);

        waveEnable = new QCheckBox(tab_9);
        waveEnable->setObjectName(QString::fromUtf8("waveEnable"));

        gridLayout_12->addWidget(waveEnable, 7, 2, 1, 1);
