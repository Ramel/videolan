...
public:
    ...
    void setupUi(QWidget *SPrefsSubtitles)
    {
        ...
        SPrefsSubtitles->resize(778, 614);
        ...
        gridLayout_2->addWidget(font, 0, 1, 1, 3);
        ...
        gridLayout_2->addWidget(backgroundCheck, 3, 3, 1, 1);
    ...
    void retranslateUi(QWidget *SPrefsSubtitles)
    {
        ...
        subLangLabel->setText(Q_("Preferred subtitles language", 0));
        encodLabel->setText(Q_("Default encoding", 0));
        groupBox->setTitle(Q_("Subtitles effects", 0));
