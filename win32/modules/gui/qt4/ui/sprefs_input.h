...
public:
    ...
    void setupUi(QWidget *SPrefsInputAndCodecs)
    {
        ...
        gridLayout->addWidget(loopFilterBox, 8, 2, 1, 2);
        ...
        gridLayout->addWidget(presetBox, 11, 1, 1, 2);

        tuneBox = new QComboBox(groupBox_3);
        tuneBox->setObjectName(QString::fromUtf8("tuneBox"));

        gridLayout->addWidget(tuneBox, 11, 3, 1, 1);

        hwAccelBox = new QCheckBox(groupBox_3);
        hwAccelBox->setObjectName(QString::fromUtf8("hwAccelBox"));

        gridLayout->addWidget(hwAccelBox, 4, 0, 1, 3);
        ...
        gridLayout->addWidget(profileBox, 12, 1, 1, 2);
        ...
        gridLayout->addWidget(PostProcLevel, 5, 2, 1, 1);
        ...
        QWidget::setTabOrder(hwAccelBox, PostProcLevel);
    ...
    void retranslateUi(QWidget *SPrefsInputAndCodecs)
    {
        ...
        hwAccelBox->setText(Q_("Use GPU accelerated decoding", 0));
