...
**
** Created: Sat Oct 20 23:38:49 2012
...
public:
    ...
    QWidget *SPrefsAudio_zone;
    QVBoxLayout *verticalLayout;
    QGroupBox *audioBox;
    QGridLayout *gridLayout;
    QRadioButton *keepVolumeRadio;
    QRadioButton *resetVolumeRadio;
    ...
    void setupUi(QWidget *SPrefsAudio)
    {
        ...
        SPrefsAudio_zone = new QWidget(SPrefsAudio);
        SPrefsAudio_zone->setObjectName(QString::fromUtf8("SPrefsAudio_zone"));
        verticalLayout = new QVBoxLayout(SPrefsAudio_zone);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        audioBox = new QGroupBox(SPrefsAudio_zone);
        audioBox->setObjectName(QString::fromUtf8("audioBox"));
        gridLayout = new QGridLayout(audioBox);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(-1, -1, -1, 0);
        keepVolumeRadio = new QRadioButton(audioBox);
        keepVolumeRadio->setObjectName(QString::fromUtf8("keepVolumeRadio"));
        keepVolumeRadio->setMinimumSize(QSize(250, 0));

        gridLayout->addWidget(keepVolumeRadio, 0, 0, 1, 2);

        resetVolumeRadio = new QRadioButton(audioBox);
        resetVolumeRadio->setObjectName(QString::fromUtf8("resetVolumeRadio"));
        resetVolumeRadio->setMinimumSize(QSize(250, 0));
        resetVolumeRadio->setChecked(true);

        gridLayout->addWidget(resetVolumeRadio, 1, 0, 1, 2);
        ...
        gridLayout->addWidget(defaultVolume_zone, 1, 2, 1, 1);


        verticalLayout->addWidget(audioBox);

        outputAudioBox = new QGroupBox(SPrefsAudio_zone);
        ...
        outputAudioLayout->setContentsMargins(-1, -1, -1, 0);
        ...
        verticalLayout->addWidget(outputAudioBox);

        groupBox_2 = new QGroupBox(SPrefsAudio_zone);
        ...
        groupBox_3 = new QGroupBox(SPrefsAudio_zone);
        ...
        gridLayout1 = new QGridLayout(lastfm_zone);
        ...
        gridLayout1->addWidget(lastfm_user_edit, 0, 1, 1, 1);
        ...
        gridLayout1->addWidget(lastfm_pass_edit, 1, 1, 1, 1);
        ...
        gridLayout1->addWidget(lastfm_pass_label, 1, 0, 1, 1);
        ...
        gridLayout1->addWidget(lastfm_user_label, 0, 0, 1, 1);
        ...
        verticalLayout_2->addWidget(SPrefsAudio_zone);
        ...
        QWidget::setTabOrder(enableAudio, keepVolumeRadio);
        QWidget::setTabOrder(keepVolumeRadio, resetVolumeRadio);
        QWidget::setTabOrder(resetVolumeRadio, defaultVolume);
    ...
    void retranslateUi(QWidget *SPrefsAudio)
    {
        ...
        keepVolumeRadio->setText(Q_("Keep audio level between sessions", 0));
        resetVolumeRadio->setText(Q_("Always reset audio start level to:", 0));
